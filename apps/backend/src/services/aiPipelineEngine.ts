 ...
 * Implements a 6-stage autonomous pipeline:
 * 1. Ground -> 2. Angles -> 3. Rank -> 4. Script & Package -> 5. Critic & Rubric -> 6. Compliance
 */
...
/**
 * Stage 1: Grounding facts & context
 */
...
/**
 * Stage 2 & 3: Angle Generation & Autonomous Ranking
 */
...
`;
  ...
  try {
    ...
    if (angles.length > 0) {
      // Sort by combined hook and monetization score
...
/**
 * Stage 4: Deep Scripting & Complete Packaging
 */
...
/**
 * Stage 5: AI Critic & Rubric Reflection Grader
 */
...
/**
 * Master Execution: Orchestrates the Full 6-Stage Autonomous AI Engine
 */
export async function executeMultiStageGeneration(
  ...
  // Matched product setup if PRODUCT_FIND mode
